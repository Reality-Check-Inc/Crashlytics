...
namespace Bindings.CrashlyticsKit
{
	...
	interface Crashlytics
	{
		...
		/*
		// +(void)setUserIdentifier:(NSString * _Nullable)identifier __attribute__((deprecated("Please access this method via +sharedInstance")));
		[Static]
		[Export("setUserIdentifier:")]
		void SetUserIdentifier([NullAllowed] string identifier);

		// +(void)setUserName:(NSString * _Nullable)name __attribute__((deprecated("Please access this method via +sharedInstance")));
		[Static]
		[Export("setUserName:")]
		void SetUserName([NullAllowed] string name);

		// +(void)setUserEmail:(NSString * _Nullable)email __attribute__((deprecated("Please access this method via +sharedInstance")));
		[Static]
		[Export("setUserEmail:")]
		void SetUserEmail([NullAllowed] string email);
		 */
		...
		/*
		// +(void)setObjectValue:(id _Nullable)value forKey:(NSString * _Nonnull)key __attribute__((deprecated("Please access this method via +sharedInstance")));
		[Static]
		[Export("setObjectValue:forKey:")]
		void SetObjectValue([NullAllowed] NSObject value, string key);

		// +(void)setIntValue:(int)value forKey:(NSString * _Nonnull)key __attribute__((deprecated("Please access this method via +sharedInstance")));
		[Static]
		[Export("setIntValue:forKey:")]
		void SetIntValue(int value, string key);

		// +(void)setBoolValue:(BOOL)value forKey:(NSString * _Nonnull)key __attribute__((deprecated("Please access this method via +sharedInstance")));
		[Static]
		[Export("setBoolValue:forKey:")]
		void SetBoolValue(bool value, string key);

		// +(void)setFloatValue:(float)value forKey:(NSString * _Nonnull)key __attribute__((deprecated("Please access this method via +sharedInstance")));
		[Static]
		[Export("setFloatValue:forKey:")]
		void SetFloatValue(float value, string key);
		 */
